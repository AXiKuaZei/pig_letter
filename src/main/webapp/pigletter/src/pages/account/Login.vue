<template>
  <q-page class="flex flex-top">
      <q-img src="../../statics/img/SpiritedAway.png">
        <div class="absolute-center transparent">
          <q-form
          @submit="onSubmit"
          @reset="onReset"
          class="q-pa-md q-gutter-y-md bg-blue-grey-2 text-dark"
        >
        ...
        <div align="center" class="q-mt-md">
          <router-link to="/" class="q-mt-lg text-dark center">回首页逛逛</router-link>
        </div>
